...
public class PVMainWindowLogin extends JFrame implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource().equals(btnLogin)){
			if(e.getSource().equals(tfUser.equals("")) || e.getSource().equals(tfPassword.equals(""))) {
				JOptionPane.showMessageDialog(this, "Error, Introduzca los datos", "ERROR", JOptionPane.OK_OPTION);
			}
			if(e.getSource().equals(tfUser.equals(""))) {
				JOptionPane.showMessageDialog(this, "Introduzca el usuario", "ERROR", JOptionPane.OK_OPTION);
			}
		}
	}
